...
try:
    ...
    try:
        if 0 < float(list_of_blood_counts[6].input_value) < 1:
            print("\033[33m{}".format(f'{list_of_blood_counts[6].name} понижены возможные причины: повышенное '
                                      f'разрушение тромбоцитов\nв следствии иммунологических факторов (аутоиммунные) '
                                      f'или неиммунологических факторов\n(тромбоцитические микроангиопатии, повреждения '
                                      f'тромбоцитов при аномальных\nповерхностях сосудов, инфекционные заболевания '
                                      f'различной вирусно-бактериальной этиологии ).'))
        if 5 < float(list_of_blood_counts[6].input_value) <= 20:
            print("\033[31m{}".format(
                f'{list_of_blood_counts[6].name} повышены возможные причины: инфекционные заболевания, '
                f'воспалительные заболевания,\nзлокачественные заболевания, быстрое восстановление после '
                f'геморрагии/гемолитической анемии,\nвозобновление симптомов после выздоровления при тромбоцитопении, '
                f'\nанатомическая аспления, железодефицит, после оперативного вмешательства.'))
    except ValueError:
    ...
    try:
        if 0 < float(list_of_blood_counts[7].input_value) < 45:
            print("\033[33m{}".format(f'{list_of_blood_counts[7].name} понижены возможные причины: повышенное '
                                      f'разрушение тромбоцитов\nв следствии иммунологических факторов (аутоиммунные) '
                                      f'или неиммунологических факторов\n(тромбоцитические микроангиопатии, повреждения '
                                      f'тромбоцитов при аномальных\nповерхностях сосудов, инфекционные заболевания '
                                      f'различной вирусно-бактериальной этиологии ).'))
        if 70 < float(list_of_blood_counts[7].input_value) <= 100:
            print("\033[31m{}".format(
                f'{list_of_blood_counts[7].name} повышены возможные причины: инфекционные заболевания, '
                f'воспалительные заболевания,\nзлокачественные заболевания, быстрое восстановление после '
                f'геморрагии/гемолитической анемии,\nвозобновление симптомов после выздоровления при тромбоцитопении, '
                f'\nанатомическая аспления, железодефицит, после оперативного вмешательства.'))
    except ValueError:
    ...
    try:
        if 0 < float(list_of_blood_counts[8].input_value) < 22:
            print("\033[33m{}".format(f'{list_of_blood_counts[8].name} понижены возможные причины: повышенное '
                                      f'разрушение тромбоцитов\nв следствии иммунологических факторов (аутоиммунные) '
                                      f'или неиммунологических факторов\n(тромбоцитические микроангиопатии, повреждения '
                                      f'тромбоцитов при аномальных\nповерхностях сосудов, инфекционные заболевания '
                                      f'различной вирусно-бактериальной этиологии ).'))
        if 46 < float(list_of_blood_counts[8].input_value) <= 100:
            print("\033[31m{}".format(
                f'{list_of_blood_counts[8].name} повышены возможные причины: инфекционные заболевания, '
                f'воспалительные заболевания,\nзлокачественные заболевания, быстрое восстановление после '
                f'геморрагии/гемолитической анемии,\nвозобновление симптомов после выздоровления при тромбоцитопении, '
                f'\nанатомическая аспления, железодефицит, после оперативного вмешательства.'))
    except ValueError:
    ...
    try:
        if 0 < float(list_of_blood_counts[9].input_value) < 2:
            print("\033[33m{}".format(f'{list_of_blood_counts[9].name} понижены возможные причины: повышенное '
                                      f'разрушение тромбоцитов\nв следствии иммунологических факторов (аутоиммунные) '
                                      f'или неиммунологических факторов\n(тромбоцитические микроангиопатии, повреждения '
                                      f'тромбоцитов при аномальных\nповерхностях сосудов, инфекционные заболевания '
                                      f'различной вирусно-бактериальной этиологии ).'))
        if 9 < float(list_of_blood_counts[9].input_value) <= 30:
            print("\033[31m{}".format(
                f'{list_of_blood_counts[9].name} повышены возможные причины: инфекционные заболевания, '
                f'воспалительные заболевания,\nзлокачественные заболевания, быстрое восстановление после '
                f'геморрагии/гемолитической анемии,\nвозобновление симптомов после выздоровления при тромбоцитопении, '
                f'\nанатомическая аспления, железодефицит, после оперативного вмешательства.'))
    except ValueError:
    ...
    try:
        if 0 < float(list_of_blood_counts[10].input_value) < 1:
            print("\033[33m{}".format(f'{list_of_blood_counts[10].name} понижены возможные причины: повышенное '
                                      f'разрушение тромбоцитов\nв следствии иммунологических факторов (аутоиммунные) '
                                      f'или неиммунологических факторов\n(тромбоцитические микроангиопатии, повреждения '
                                      f'тромбоцитов при аномальных\nповерхностях сосудов, инфекционные заболевания '
                                      f'различной вирусно-бактериальной этиологии ).'))
        if 5 < float(list_of_blood_counts[10].input_value) <= 20:
            print("\033[31m{}".format(
                f'{list_of_blood_counts[10].name} повышены возможные причины: инфекционные заболевания, '
                f'воспалительные заболевания,\nзлокачественные заболевания, быстрое восстановление после '
                f'геморрагии/гемолитической анемии,\nвозобновление симптомов после выздоровления при тромбоцитопении, '
                f'\nанатомическая аспления, железодефицит, после оперативного вмешательства.'))
    except ValueError:
    ...
    try:
        if 0 < float(list_of_blood_counts[11].input_value) < 0.01:
            print("\033[33m{}".format(f'{list_of_blood_counts[11].name} понижены возможные причины: повышенное '
                                      f'разрушение тромбоцитов\nв следствии иммунологических факторов (аутоиммунные) '
                                      f'или неиммунологических факторов\n(тромбоцитические микроангиопатии, повреждения '
                                      f'тромбоцитов при аномальных\nповерхностях сосудов, инфекционные заболевания '
                                      f'различной вирусно-бактериальной этиологии ).'))
        if 1 < float(list_of_blood_counts[11].input_value) <= 20:
            print("\033[31m{}".format(
                f'{list_of_blood_counts[11].name} повышены возможные причины: инфекционные заболевания, '
                f'воспалительные заболевания,\nзлокачественные заболевания, быстрое восстановление после '
                f'геморрагии/гемолитической анемии,\nвозобновление симптомов после выздоровления при тромбоцитопении, '
                f'\nанатомическая аспления, железодефицит, после оперативного вмешательства.'))
    except ValueError:
    ...
    try:
        if 0 < float(list_of_blood_counts[12].input_value) < 2:
            print("\033[33m{}".format(f'{list_of_blood_counts[12].name} понижены возможные причины: повышенное '
                                      f'разрушение тромбоцитов\nв следствии иммунологических факторов (аутоиммунные) '
                                      f'или неиммунологических факторов\n(тромбоцитические микроангиопатии, повреждения '
                                      f'тромбоцитов при аномальных\nповерхностях сосудов, инфекционные заболевания '
                                      f'различной вирусно-бактериальной этиологии ).'))
        if 8 < float(list_of_blood_counts[12].input_value) <= 30:
            print("\033[31m{}".format(
                f'{list_of_blood_counts[12].name} повышены возможные причины: инфекционные заболевания, '
                f'воспалительные заболевания,\nзлокачественные заболевания, быстрое восстановление после '
                f'геморрагии/гемолитической анемии,\nвозобновление симптомов после выздоровления при тромбоцитопении, '
                f'\nанатомическая аспления, железодефицит, после оперативного вмешательства.'))
    except ValueError:
